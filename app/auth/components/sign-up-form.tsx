...
export function SignupForm({
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (existingPhone) {
        setError("رقم التليفون مستخدم بالفعل");
        setIsLoading(false);
        return;
      }
      ...
      router.push("/auth?mode=confirm-email");
    } catch (error: unknown) {
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        <CardHeader>
          <CardTitle
            className="text-2xl font-lifta text-center mb-4
          "
          >
            إنشاء حساب جديد
          </CardTitle>
              ...
              <div className="flex justify-between items-center gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    pattern="[0-9]{11}"
                    title="رقم التليفون يجب أن يكون 11 رقم"
                  />
                </div>
              </div>
              <div className="grid gap-2">
