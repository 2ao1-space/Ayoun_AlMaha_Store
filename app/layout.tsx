...
export const metadata: Metadata = {
  ...
  description:
    "متجر عمـار ياسـر للبصريات - نظارات طبية وشمسية فاخرة، تصاميم عالمية، وأسعار تناسب الجميع. ضمان شامل وخدمة عملاء مميزة.",
  keywords: [
    "نظارات",
    "نظارات طبية",
    "نظارات شمسية",
  ...
  openGraph: {
    title: "عمـار ياسـر - نظارات فاخرة بأسعار استثنائية",
    description: "متجر عمـار ياسـر للبصريات - جودة عالمية وأسعار مناسبة",
    type: "website",
    locale: "ar_EG",
  },
};
